...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    static get observedAttributes() {
      return ['shape', 'radius', 'mask', 'fit', 'position', 'placeholder', 'src', 'id', 'blank'];
    }
    ...
    constructor() {
      ...
      this._empty.addEventListener('click', () => {
        if (this.hasAttribute('blank')) return;
        this._input.click();
      });
    ...
    _render() {
      ...
      if (url) {
        ...
        this._empty.style.display = this.hasAttribute('blank') ? 'none' : 'flex';
        this._ring.style.display = this.hasAttribute('blank') ? 'none' : '';
